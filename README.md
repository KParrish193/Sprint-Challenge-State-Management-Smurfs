...
- [ ] What problem does the context API help solve?
  ...
  It solves the problem of havinbg to pass state through various component levels of your App via props/prop drilling by storing state in an easily accessible context object that can be accessed globally vs passed down multiple layers.
...
- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
  ...
  The store is known as a 'single source of truth' in a redux application because it contains the application state and because it is immutable - all functions in Redux must be pure functions and return a copy of our state vs changing the store/application state. 
